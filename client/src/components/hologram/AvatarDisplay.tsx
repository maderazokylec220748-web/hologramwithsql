...
export function AvatarDisplay({ isSpeaking, isMuted, onToggleMute }: AvatarDisplayProps) {
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="relative">
        ...
        {/* Avatar circle */}
        <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-[hsl(0,75%,25%)] to-[hsl(0,75%,35%)] border-4 border-[hsl(48,100%,50%)] flex items-center justify-center overflow-hidden">
          {/* AI Icon */}
          <motion.div
            animate={{
